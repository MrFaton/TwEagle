package com.mr_faton.core.execution_pool.impl;
...
public class OptimalExecutor implements ExecutionPool {
    private static final Logger logger = Logger.getLogger("" +
            "com.mr_faton.core.execution_pool.impl.OptimalExecutor");
    ...
    public OptimalExecutor() {
        ...
        BlockingQueue<Runnable> queue = new ArrayBlockingQueue<>(QUEUE_SIZE, true);
        pool = new ThreadPoolExecutor(ROOT_THREADS, MAX_POOL_SIZE, THREAD_LIFE_TIME, TimeUnit.MINUTES, queue);
    }
